...
function AboutUs() {
    ...
    return (
        <section className="info-section pt-16 md:pt-24 " id='about'>
            ...
            <div className='info-wrapper grid grid-cols-1 md:grid-cols-2 gap-6 w-[90%] mx-auto  mt-8'>
                ...
                <div className='flex w-full gap-6 flex-col sm:flex-row md:flex-col'>
                    <div className="mission-box relative overflow-hidden rounded-2xl   sm:w-1/2 md:w-full md:h-1/2 h-[200px] flex flex-col gap-2 justify-center items-center bg-purple-400 p-8 group hover:-translate-y-2 transition-all duration-500" id='mission'>
                    ...
                    <div className="vision-box relative overflow-hidden rounded-2xl sm:w-1/2  md:w-full md:h-1/2 h-[200px] flex flex-col gap-2 justify-center items-center bg-purple-300 p-8 group hover:-translate-y-2 transition-all duration-500">

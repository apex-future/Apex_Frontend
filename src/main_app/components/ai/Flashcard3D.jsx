  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Back of Card (Answer) */}
        <div 
          className="absolute inset-0 w-full h-full backface-hidden rotate-y-180 rounded-2xl sm:rounded-3xl p-5 sm:p-6 md:p-8 flex flex-col justify-center items-center text-center overflow-y-auto"
          style={{
            background: isDark 
        ...
        >
          <div className="absolute top-4 sm:top-6 left-4 sm:left-6 text-accent-primary opacity-50">
            <ArrowUUpLeft size={20} weight="bold" className="sm:w-6 sm:h-6" />
          </div>
          <p className="text-sm sm:text-base md:text-lg font-medium text-text-primary leading-relaxed mt-4">
            {answer}
          </p>
        </div>

...
function SimplifyModal({ originalText, simplifiedText, loading, error, onRetry, onClose }) {
    return (
        <>
            ...
            >
                <Card className="overflow-hidden font-sans !p-0">
                    {/* Header */}
                    ...
                    <div className="p-5">
                        ...
                        {originalText && (
                            <div className="mb-4 bg-black/10 dark:bg-white/10 p-3 rounded-xl">
                        ...
                        {simplifiedText && !loading && !error && (
                            <div className="bg-black/10 dark:bg-white/10 rounded-xl p-4 animate-in slide-in-from-bottom-2 duration-300">

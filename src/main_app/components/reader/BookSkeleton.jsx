...
const BookSkeleton = ({ message = "Loading..." }) => {
  return (
    <div className="flex flex-col items-center justify-center w-full min-h-screen bg-[#faf9f6] p-6 animate-in fade-in duration-700">
      ...
      <div className="w-full max-w-2xl bg-white shadow-2xl rounded-sm p-8 md:p-12 relative overflow-hidden aspect-[1/1.4] border border-slate-100">
        ...
        <div className="space-y-6">
          {/* Header-like line */}
          <div className="h-4 w-1/3 bg-slate-100 rounded-full mb-12" />
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 h-2 w-8 bg-slate-100 rounded-full" />
      </div>
      ...
      <div className="mt-12 flex flex-col items-center gap-3">
        ...
        <p className="text-slate-400 font-sans text-sm font-medium tracking-widest uppercase animate-pulse">
            {message}
        </p>
      </div>
